...
const url = 'https://wtr-lab.com/en/novel/6588/online-game-god-tier-assassin-i-am-the-shadow/chapter-1109?service=web';
...
function crawlPage(url) {
    ...
    if (!error && response.statusCode == 200) {
		...
		const ChapterTitle = $('h3.chapter-title').text();
